    ...
    <div id='home' className='introduction'>
      ...
      <div className="introduction_wrapper container">
       ...
       <div className="int_info_1">
        ...
        <p data-aos="fade-down-left"  data-aos-duration="1500">Cool boy ,</p>
       </div>
       <div className="int_info_2">
        <p data-aos="fade-up-right"  data-aos-duration="1500">Freeliancer ,</p>
        <p data-aos="fade-up-left"  data-aos-duration="1500">Juniour  programmer,</p>
       </div>
